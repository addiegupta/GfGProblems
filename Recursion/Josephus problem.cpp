...
Link to Problem: https://practice.geeksforgeeks.org/problems/josephus-problem/1
...
int josephus(int n, int k)
{
	...
	if(n==1) return 1;
	// n-1: one person has been killed
	// + k-1: traverse through k-1 people
	// %n +1 : compensates for going out of range 
